...
bool CPageNavigator::eventFilter(QObject *watched, QEvent *e)
{
...
int CPageNavigator::getBlockSize() const
{
    return m_blockSize;
}

int CPageNavigator::getMaxPage() const
{
    return m_maxPage;
}

int CPageNavigator::getCurrentPage() const
{
    return m_currentPage;
}

void CPageNavigator::setMaxPage(int page)
{
    page = qMax(page, 1);
...
void CPageNavigator::setCurrentPage(int page, bool signalEmitted/* = false*/)
{
    page = qMax(page, 1);
...
void CPageNavigator::setBlockSize(int blockSize)
{
...
// 初始化页码的labels
// 分成三个部分, 左...中...右
void CPageNavigator::initialize()
{
...
void CPageNavigator::updatePageLabels()
{
